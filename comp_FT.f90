    ...
    do i = doy(1),doy(2) ! i é linha
        do j = dox(1),dox(2)
            ...
            do while (associated(node))
                ...
                if (rs1 > 0 .and. i /= doy(1) .and. i /= doy(2) .and. j /= dox(1) .and. j /= dox(2)) then
                    ! print*, ">id", id, "parlist", partlst
                    ! print*, "PG id",id,"i j", i, j 
                    ! print*, "id",id, "dox,doy", dox,doy
                    ! print*, "id",id,"pa",ptr%p%n - pa
